...
iterRank = cell(nranks, nCycles);
        ...
        for nc=1:nCycles
            for r=1:nranks
                file = [dir, num2str(nCycles),'_cycles/',num2str(sranks),'x',num2str(nranks),'/coarse_PIC/coarse_dt_0.05/test_wo_kokkos_custom/data/localError_rank_', num2str(r-1),'_nc_',num2str(nc),'.csv'];
            ...
            for iter=1:max_iter
                ...
                for r=start_rank:step:end_rank
                    ...
                    if(iter <= iterRank{r,nc}(end))
                        file = [dir, num2str(nCycles),'_cycles/',num2str(sranks),'x',num2str(nranks),'/coarse_PIC/coarse_dt_0.05/test_wo_kokkos_custom/data/Energy_rank_', num2str(r-1),'_nc_',num2str(nc),'_iter_',num2str(iter),'.csv'];
        ...
        exportgraphics(fig,[test_str,'_Momentum_error_',grid_str,'_',Np_str,'_',time_str,'_nycles_',num2str(nCycles),'_nranks_',num2str(nranks),'.pdf']);
